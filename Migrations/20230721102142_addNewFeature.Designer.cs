...
namespace perpark_api.Migrations
{
    ...
    [Migration("20230721102142_addNewFeature")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("perpark_api.Models.User", b =>
                {
                    b.HasOne("perpark_api.Models.Entities.City", "City")
                        .WithMany()
                        .HasForeignKey("CityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("perpark_api.Models.Entities.District", "District")
                        .WithMany()
                        .HasForeignKey("DistrictId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("perpark_api.Models.UserType", "UserType")
                        .WithMany("Users")
